...
class SILab2Test {
    ...
    void everyBranchTest(){
        ...
        //2.
        assertTrue(() -> SILab2.checkCart(List.of(new Item(null,"012",350,-1), new Item("something","123",250, 0.5F)), 1000));

        //3.
        assertFalse(() -> SILab2.checkCart(List.of(new Item(null,"012",350,-1), new Item("something","123",250, 0.5F)), 10));
